...
import CM_About from './Page/ContentManagement/Pages/About/Main';
import Edit_About from './Page/ContentManagement/Pages/About/EditContent';
                ...
                {inCM && !isAuthPage && (
                  <main className="flex-1 mt-16 bg-sky-100">
                    ...
                    >
                      ...
                      <Route path="Pages/About" element={<CM_About />}/>
                    </Route>
                  </Routes>
                </main>
                )}
